        ...
        function () {
            ...
            function (t, e, n) {
                ...
                function o(t, e, n, r, o, a, s, u, h, l, d) {
                    ...
                    for (g = 0; g < 1; g += .05) p = new c(i(t, n, o, s, g), i(e, r, a, u, g)),
                        ...
                        v < _ && (f = g, _ = v);
                    _ = 1 / 0;
                    for (var A = 0; A < 32 && !(b < M); A++) x = f - b,
                        w = f + b,
                        p = new c(i(t, n, o, s, x), i(e, r, a, u, x)),
                        v = p.distanceToSquared(S),
                        x >= 0 && v < _ ? (f = x, _ = v) : (y = new c(i(t, n, o, s, w), i(e, r, a, u, w)), m = y.distanceToSquared(S), w <= 1 && m < _ ? (f = w, _ = m) : b *= .5);
            ...
            function (t, e, n) {
                ...
                function r(t, e, n, r, o, s, u, c, h) {
                    ...
                    for (p = 0; p < 1; p += .05) f = new a(i(t, n, o, p), i(e, r, s, p)),
                        ...
                        d < x && (l = p, x = d);
                    for (x = 1 / 0, m = 0; m < 32 && !(y < w); m++) {
                        var _ = l - y,
                            M = l + y;
                        f = new a(i(t, n, o, _), i(e, r, s, _)),
                            d = f.distanceToSquared(b),
                            _ >= 0 && d < x ? (l = _, x = d) : (g = new a(i(t, n, o, M), i(e, r, s, M)), v = g.distanceToSquared(b), M <= 1 && v < x ? (l = M, x = v) : y *= .5)
                    }
                        ...
                        for (var l, d, f = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), g = h, p = t.length; g < p; g++) {
                            if (n.push(l = []), d = t[g], e = d[0], e != e.toUpperCase()) switch (l[0] = e.toUpperCase(), l[0]) {
                                ...
                                case "H":
                                    ...
                                    break;
                                case "R":
                                    for (var v = [i, r].concat(d.slice(1)), m = 2, y = v.length; m < y; m++) v[m] = +v[m] + i,
                                        v[++m] = +v[m] + r;
                                    n.pop(),
                                        n = n.concat(s(v, f));
                                    break;
                                ...
                                case "M":
                                    o = +d[1] + i,
                                        c = +d[2] + r;
                                default:
                                    for (m = 1, y = d.length; m < y; m++) l[m] = +d[m] + (m % 2 ? i : r)
                    ...
                    d = function (t, e, n, i, r, o, a, s, u, c) {
                        ...
                        if (c) S = c[0],
                            ...
                            var v = (Math.cos(Math.PI / 180 * r), Math.sin(Math.PI / 180 * r), (t - s) / 2),
                                m = (e - u) / 2,
                                y = v * v / (n * n) + m * m / (i * i);
                            y > 1 && (y = Math.sqrt(y), n *= y, i *= y);
                            var x = n * n,
                                w = i * i,
                                b = (o == a ? -1 : 1) * Math.sqrt(Math.abs((x * w - x * m * m - w * v * v) / (x * m * m + w * v * v))),
                                _ = b * n * m / i + (t + s) / 2,
                                M = b * -i * v / n + (e + u) / 2,
                        ...
                        var I = Math.cos(S),
                            ...
                            G = [s + O * F, u - z * B],
                            X = [s, u];
                        if (D[0] = 2 * R[0] - D[0], D[1] = 2 * R[1] - D[1], c) return [D, G, X].concat(g);
                        ...
                        for (var n = c(t), i = e && c(e), r = {
                            ...
                            a = (function (t, e, n) {
                                ...
                                if (t[e].length > 7) {
                                    ...
                                    t.splice(e, 1),
                                        y = Math.max(n.length, i && i.length || 0)
                                }
                            },
                            u = function (t, e, r, o, a) {
                                t && e && "M" == t[a][0] && "M" != e[a][0] && (e.splice(a, 0, ["M", o.x, o.y]), r.bx = 0, r.by = 0, r.x = t[a][1], r.y = t[a][2], y = Math.max(n.length, i && i.length || 0))
                            },
                            f = [], g = [], p = "", v = "", m = 0, y = Math.max(n.length, i && i.length || 0); m < y; m++) {
                            n[m] && (p = n[m][0]),
                                "C" != p && (f[m] = p, m && (v = f[m - 1])),
                                n[m] = a(n[m], r, v),
                                "A" != f[m] && "C" == p && (f[m] = "C"),
                            ...
                            r.x = x[b - 2],
                                r.y = x[b - 1],
                                r.bx = parseFloat(x[b - 4]) || r.x,
                                r.by = parseFloat(x[b - 3]) || r.y,
                ...
                u.fromNode = function (t, e) {
                    ...
                    t.exports = function (t) {
                        function e(t) {
                            ...
                            e(t.c[0]);
                            for (var r = y(l(t.c[0].el), 0, null), o = 1; o < t.cs; ++o) {
                                e(t.c[o]);
                                var a = l(t.c[o].er);
                                i(t, o, r),
                                    r = y(a, o, r)
            ...
            function (t, e, n) {
                ...
                function u(t, e, n, i, r, o, u) {
                    ...
                    var y = Math.sqrt((r * r * (o * o) - r * r * (v * v) - o * o * (p * p)) / (r * r * (v * v) + o * o * (p * p)));
                    n === i && (y *= -1),
                        isNaN(y) && (y = 0);
                    var x = y * r * v / o,
                        w = y * -o * p / r,
                        b = (l + f) / 2 + Math.cos(c) * x - Math.sin(c) * w,
                        _ = (d + g) / 2 + Math.sin(c) * x + Math.cos(c) * w,
                        M = s([1, 0], [(p - x) / r, (v - w) / o]),
                        S = [(p - x) / r, (v - w) / o],
                        A = [(- 1 * p - x) / r, (- 1 * v - w) / o],
                        P = s(S, A);
                        ...
                        switch (r) {
                            ...
                            case "A":
                                ...
                                return _.translate(- u, -c),
                                    ...
                                    _.scale(1 / w, 1 / b),
                                    s.applyMatrix(_),
                                    l.arcline(0, 0, x, f, f + g, 1 - v, n, s.x, s.y)
                        }
                        return !1
                    },
                    draw: function (t) {
                        ...
                        switch (this.command) {
                            ...
                            case "A":
                                ...
                                for (i = 2 * -Math.PI; i <= 2 * Math.PI; i += Math.PI) {
                                    var A = b + i;
                                    1 === y ? x < A && A < w && S.push(A) : w < A && A < x && S.push(A)
                                }
                                ...
                                for (i = 2 * -Math.PI; i <= 2 * Math.PI; i += Math.PI) {
                                    var k = T + i;
                                    1 === y ? x < k && k < w && I.push(k) : w < k && k < x && I.push(k)
                                }
                ...
                var i = n(1),
                    ...
                    g = function (t, e, n, i, r, o, a, s, u, c) {
                        ...
                        var I = Math.cos(S),
                            ...
                            G = [s + O * F, u - z * B],
                            X = [s, u];
                        if (D[0] = 2 * R[0] - D[0], D[1] = 2 * R[1] - D[1], c) return [D, G, X].concat(f);
                    ...
                    p = function (t, e) {
                        for (var n = l(t), i = e && l(e), r = {
                            ...
                            c = [], h = [], p = "", v = "", m = 0, y = Math.max(n.length, i && i.length || 0); m < y; m++) {
                            n[m] && (p = n[m][0]),
                                "C" != p && (c[m] = p, m && (v = c[m - 1])),
                                n[m] = a(n[m], r, v),
                                "A" != c[m] && "C" == p && (c[m] = "C"),
                    ...
                    b = function (t, e, n, i, r, o, a, s) {
                        for (var u, c, h, l, d, f, g, p, v = [], m = [[], []], y = 0; y < 2; ++y) if (0 == y ? (c = 6 * t - 12 * n + 6 * r, u = -3 * t + 9 * n - 9 * r + 3 * a, h = 3 * n - 3 * t) : (c = 6 * e - 12 * i + 6 * o, u = -3 * e + 9 * i - 9 * o + 3 * s, h = 3 * i - 3 * e), Math.abs(u) < 1e-12) {
                        ...
                        for (var x, w = v.length,
                            b = w; w--;) l = v[w],
                                x = 1 - l,
                                m[0][w] = x * x * x * t + 3 * x * x * l * n + 3 * x * l * l * r + l * l * l * a,
                                m[1][w] = x * x * x * e + 3 * x * x * l * i + 3 * x * l * l * o + l * l * l * s;
                        return m[0][b] = t,
                            m[1][b] = e,
                            m[0][b + 1] = a,
                            m[1][b + 1] = s,
                    ...
                    T = function (t, e, n, i, o, a, s, u, c) {
                        var h = 1 - c,
                            ...
                            y = e + 2 * c * (i - e) + f * (a - 2 * i + e),
                            x = n + 2 * c * (o - n) + f * (s - 2 * o + n),
                            w = i + 2 * c * (a - i) + f * (u - 2 * a + i),
                            b = h * t + c * n,
                            _ = h * e + c * i,
                            M = h * o + c * s,
                            S = h * a + c * u,
                            A = 90 - 180 * Math.atan2(m - x, y - w) / r;
                        return {
                            x: p,
                            y: v,
                            m: {
                ...
                r.augment(o, {
                    ...
                    onMouseMove: function (t) {
                        ...
                        this.pressing !== !0 || n.x === i.x && n.y === i.y || (this.pressing = !1),
                            i && n && (i.toEvObj = n, n.fromEvObj = i, this.isSame(i, n, "shape") || (i.shape && !i.shape.get("destroyed") && e.fire("mouseleave", this.getEventObj(i)), n.shape && !n.shape.get("destroyed") && e.fire("mouseenter", this.getEventObj(n))), this.isSame(i, n, "item") || (i.item && !i.item.destroyed && e.fire("itemmouseleave", this.getEventObj(i)), n.item && !n.item.destroyed && e.fire("itemmouseenter", this.getEventObj(n)))),
                            this.dragging && (this.dragStartPoint ? e.fire("dragmove", this.getEventObj(n)) : (this.dragStartPoint = {
                                x: n.x,
                                y: n.y
                            },
                                this.dragItem = n.item, e.fire("dragstart", this.getEventObj(n)))),
                    ...
                    a.augment(E, {
                        ...
                        _initDOM: function () {
                            ...
                            var p = r ? h.addGroup(S) : h.addGroup(),
                                ...
                                m = p.addGroup(),
                                y = p.addGroup(),
                                x = n ? y.addGroup(M) : y.addGroup(),
                                w = o ? y.addGroup(M) : y.addGroup(),
                                b = p.addGroup(),
                                A = v.addGroup({
                                    capture: !1
                                }),
                        ...
                        tooltip: function t(e) {
                            ...
                            return e ? (a.isObject(n) && n.destroy(), a.isObject(e) && a.mix(t, e), n = new x(t), this.set("tooltipAssist", n)) : (n && n.destroy(), this.set("tooltipAssist", null)),
                                this
                        },
                        getItem: function (t) {
                            if (!t) return null;
                    ...
                    i.augment(o, {
                        ...
                        _getEdgePoints: function () {
                            var t = this,
                                ...
                                y = void 0;
                            return o ? (null === u && delete e.sourceAnchor, null === c && delete e.targetAnchor, i.isNumber(u) && n && (u = n.getAnchor(u)), i.isNumber(c) && r && (c = r.getAnchor(c)), d > 2 ? (n && !u && (u = n.getAnchor(s[p + 1])), r && !c && (c = r.getAnchor(s[v - 1]))) : (y = m && g.getPath(f.shape, [h, l]), n && !u && (u = y ? n.getAnchor(y) : n.getAnchor(l)), r && !c && (c = y ? r.getAnchor(y) : r.getAnchor(h))), s[0] = {
                                x: u.x,
                                y: u.y
                            },
                                s[v] = {
                    ...
                    i.augment(r, {
                        _initLayout: function () {
                            var t = this.get("layoutFn"),
                                ...
                                n = this.get("layout"); !n && t && e && (n = new t(e), this.set("layout", n))
                        },
                        layout: function () { },
                        ...
                        _doLayout: function () {
                            ...
                            t && (this._setNodeSize(), this._setEdgeSize(), e && this.layout())
                        },
                        ...
                        for (var s = this,
                            ...
                            },
                            {
                                ...
                                var m = f[p],
                                    ...
                                    T = (x - b) * (S - P) - (w - _) * (M - A);
                                if (T) {
                                    var E = ((x * _ - w * b) * (M - A) - (x - b) * (M * P - S * A)) / T,
                                        C = ((x * _ - w * b) * (S - P) - (w - _) * (M * P - S * A)) / T,
                                        I = [E, C];
            ...
            function (t, e, n) {
                ...
                i.collapse = function (t) {
                    t._on("click",
                        function (e) {
                            var n = e.shape;
                            n && n.hasClass("collapseButton") && (t.fire("collapse", e), t.css({
                                cursor: "default"
                            }))
                        }),
                        t._on("collapse",
            ...
            function (t, e, n) {
                ...
                i.spreadout = function (t) {
                    t._on("click",
                        function (e) {
                            var n = e.shape;
                            n && n.hasClass("spreadoutButton") && (t.fire("spreadout", e), t.css({
                                cursor: "default"
                            }))
                        }),
                        t._on("spreadout",
            ...
            function (t, e, n) {
                ...
                n(194),
                    r.Mode = {
                        default:
                        ["dragBlank", "collapse", "spreadout", "buttonPointer", "wheelZoom"],
                        none: []
                    },
                ...
                l.ATTRS = {
                    ...
                    i.augment(l, {
                        ...
                        layout: function t() {
                            var t = this.get("layout"),
                                e = this.get("data");
                            i.isObject(t) ? t.execute() : i.isFunction(t) && t(e),
                                this.updateNodesPosition()
                        },
                        source: function (t) {
